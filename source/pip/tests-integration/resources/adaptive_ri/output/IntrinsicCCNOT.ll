...
@2 = internal constant [8 x i8] c"2_t0a2r\00"
@3 = internal constant [8 x i8] c"3_t1a0r\00"
@4 = internal constant [8 x i8] c"4_t1a1r\00"
@5 = internal constant [8 x i8] c"5_t1a2r\00"
...
block_0:
  ...
  call void @__quantum__qis__ccx__body(%Qubit* inttoptr (i64 3 to %Qubit*), %Qubit* inttoptr (i64 4 to %Qubit*), %Qubit* inttoptr (i64 5 to %Qubit*))
  ...
  call void @__quantum__rt__result_record_output(%Result* inttoptr (i64 7 to %Result*), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @7, i64 0, i64 0))
  call void @__quantum__rt__result_record_output(%Result* inttoptr (i64 8 to %Result*), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @8, i64 0, i64 0))
  ret i64 0
}
