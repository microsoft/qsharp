...
fn if_expression_with_false_condition() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            Blocks:
            Block 0:Block:
                Call id(1), args( Integer(0), Tag(0, 3), )
                Return"#]],
    );
}
...
fn if_expression_with_classical_operand_from_hybrid_integers_array() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 4:Block:
                Call id(4), args( Integer(2), Tag(0, 3), )
                Call id(5), args( Variable(2, Integer), Tag(1, 5), )
                Call id(5), args( Variable(5, Integer), Tag(2, 5), )
                Return
            Block 5:Block:
...
fn if_expression_with_classical_operand_from_hybrid_doubles_array() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 4:Block:
                Call id(4), args( Integer(2), Tag(0, 3), )
                Call id(5), args( Variable(2, Double), Tag(1, 5), )
                Call id(5), args( Variable(5, Double), Tag(2, 5), )
                Return
            Block 5:Block:
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 6:Block:
                Call id(4), args( Integer(2), Tag(0, 3), )
                Call id(5), args( Variable(2, Double), Tag(1, 5), )
                Call id(5), args( Variable(6, Double), Tag(2, 5), )
                Return
            Block 7:Block:
