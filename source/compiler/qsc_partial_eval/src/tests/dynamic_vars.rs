    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 0:Block:
                ...
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[137-147]
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 0:Block:
                ...
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[143-153]
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 1:Block:
                ...
                Call id(3), args( Variable(3, Double), Qubit(1), ) !dbg package_id=2 span=[0-0]
