...
fn array_with_dynamic_content() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[122-133]
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[135-146]
...
fn array_repeat_with_dynamic_content() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[104-114]
                Call id(2), args( Integer(2), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(0), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(0), Pointer, ) !dbg package_id=2 span=[50-54]
                Return !dbg package_id=2 span=[50-54]"#]],
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                ...
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[147-158]
...
fn result_array_slice_with_explicit_range() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[169-180]
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[182-193]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[195-206]
                Call id(1), args( Qubit(3), Result(3), ) !dbg package_id=2 span=[208-219]
                Call id(1), args( Qubit(4), Result(4), ) !dbg package_id=2 span=[221-232]
...
fn result_array_slice_with_open_start_range() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[143-154]
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[156-167]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[169-180]
                Call id(2), args( Integer(2), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(0), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(1), Pointer, ) !dbg package_id=2 span=[50-54]
                Return !dbg package_id=2 span=[50-54]"#]],
...
fn result_array_copy_and_update_with_single_index() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[156-167]
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[169-180]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[182-193]
                Call id(1), args( Qubit(3), Result(3), ) !dbg package_id=2 span=[214-225]
                Call id(2), args( Integer(3), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(0), Pointer, ) !dbg package_id=2 span=[50-54]
...
fn result_array_copy_and_update_with_explicit_range() {
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                Call id(1), args( Qubit(0), Result(0), ) !dbg package_id=2 span=[231-242]
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[244-255]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[257-268]
                Call id(1), args( Qubit(3), Result(3), ) !dbg package_id=2 span=[270-281]
                Call id(1), args( Qubit(4), Result(4), ) !dbg package_id=2 span=[283-294]
                Call id(1), args( Qubit(5), Result(5), ) !dbg package_id=2 span=[322-335]
                Call id(1), args( Qubit(6), Result(6), ) !dbg package_id=2 span=[337-350]
                Call id(1), args( Qubit(7), Result(7), ) !dbg package_id=2 span=[352-365]
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                ...
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[182-193]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[195-206]
                Call id(1), args( Qubit(3), Result(3), ) !dbg package_id=2 span=[231-242]
                Call id(1), args( Qubit(4), Result(4), ) !dbg package_id=2 span=[244-255]
                Call id(2), args( Integer(3), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(3), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(4), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(2), Pointer, ) !dbg package_id=2 span=[50-54]
    ...
    assert_block_instructions(
        ...
        &expect![[r#"
            Block:
                ...
                Call id(1), args( Qubit(1), Result(1), ) !dbg package_id=2 span=[182-193]
                Call id(1), args( Qubit(2), Result(2), ) !dbg package_id=2 span=[195-206]
                Call id(1), args( Qubit(3), Result(3), ) !dbg package_id=2 span=[234-245]
                Call id(1), args( Qubit(4), Result(4), ) !dbg package_id=2 span=[247-258]
                Call id(2), args( Integer(3), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(3), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(1), Pointer, ) !dbg package_id=2 span=[50-54]
                Call id(3), args( Result(4), Pointer, ) !dbg package_id=2 span=[50-54]
