...
struct DoubleFactorizedChemistryProblem {
...
struct DoubleFactorizedChemistryParameters {
...
internal struct DoubleFactorizedChemistryConstants {
...
internal struct OneElectronOperator {
    NGarbageQubits : Int,
...
internal struct TwoElectronOperator {
    NGarbageQubits : Int,
...
internal function AllEigenVectorsAsBitString(eigenVectors : Double[][], precision : Int) : Bool[][] {
    ...
    for eigenVector in eigenVectors {
        ...
        for index in 0..Length(eigenVector) - 2 {
            ...
            let theta = AbsD(sins) < 0.00000001 ? 0.0 | 0.5 * ArcCos(MinD(eigenVector[index] / sins, 1.0));
