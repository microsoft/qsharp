...
qsharp_string = (
    "DoubleFactorizedChemistry.DoubleFactorizedChemistry("
    "DoubleFactorizedChemistry.DoubleFactorizedChemistryProblem("
    ...
    "DoubleFactorizedChemistry.DoubleFactorizedChemistryParameters(0.001,))"
)
