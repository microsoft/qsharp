...
> Trigonometric functions are available in Q# via the `Microsoft.Quantum.Math` namespace. In this case we will need <a href="https://docs.microsoft.com/qsharp/api/qsharp-lang/microsoft.quantum.math.arctan2" target="_blank">ArcTan2</a>.
