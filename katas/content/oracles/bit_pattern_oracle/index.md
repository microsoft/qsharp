...
<details>
  ...
  You need to flip the state of $|y\rangle$ if $|x\rangle$ matches the given pattern.  You may find the Q# library operation `ApplyControlledOnBitString` useful in your implementation.
</details>
