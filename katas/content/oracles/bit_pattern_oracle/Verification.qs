    ...
    operation CheckSolution() : Bool {
        for N in 1..3 {
            for k in 0..2^N - 1 {
                ...
                if not isCorrect {
                    Message("Incorrect.");
                    Message("Hint: examine how your solution transforms the given state and compare it with the expected " + $"transformation for the {N}-bit oracle for the pattern {pattern}");
