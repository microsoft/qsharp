...
#[wasm_bindgen]
pub struct JsProjectLoader {
    lookup_fn: js_sys::Function,
    list_dir_fn: js_sys::Function,
}

#[wasm_bindgen]
pub struct JsManifestDescriptor {
...
impl From<JsManifestDescriptor> for qsc_project::ManifestDescriptor {
    fn from(value: JsManifestDescriptor) -> Self {
...
impl FileSystem for JsProjectLoader {
    type Entry = qsc_project::JsFileEntry;
...
impl JsProjectLoader {
    ...
    #[wasm_bindgen]
    pub fn load(&mut self, manifest: JsManifestDescriptor) -> Result<js_sys::Array, String> {
        let proj = self
