...
export interface ICompiler {
  ...
  getDocumentationFiles(): Promise<IDocFile[]>;
...
export class Compiler implements ICompiler {
  ...
  // This include file names and metadata, including specially formatted
  // table of content file.
  async getDocumentationFiles(): Promise<IDocFile[]> {
    return this.wasm.generate_docs();
  }

  // Returns autogenerated documentation for the standard library
  // and loaded project (if requested). Only the array of documentation
  // content is returned.
...
export const compilerProtocol: ServiceProtocol<ICompiler, QscEventData> = {
  ...
  methods: {
    ...
    getCircuit: "request",
    getDocumentationFiles: "request",
    getDocumentationContent: "request",
