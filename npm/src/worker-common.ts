    ...
    function doNextRequest() {
        ...
        switch (curr.type) {
            ...
            case "getCompletions":
                ...
                break;
            case "run":
                msg = { type: "run", code: curr.args[0], expr: curr.args[1], shots: curr.args[2] };
                break;
            case "runKata":
                msg = { type: "runKata", user_code: curr.args[0], verify_code: curr.args[1] };
                break;
            default:
...
export function getWorkerEventHandlers(postMessage: (msg: CompilerEventMsg) => void): IQscEventTarget {
