...
function createPathMap(input: ReData): Map<string, any> {
  const r = new Map<string, any>();
  r.set("errorBudget/rotations", input.errorBudget.rotations);
  r.set(
    "jobParams/qecScheme/crossingPrefactor",
    input.jobParams.qecScheme.crossingPrefactor,
  );
  r.set(
    "jobParams/qecScheme/errorCorrectionThreshold",
    input.jobParams.qecScheme.errorCorrectionThreshold,
  );
  r.set(
    "jobParams/qecScheme/logicalCycleTime",
    input.jobParams.qecScheme.logicalCycleTime,
  );
  r.set(
    "jobParams/qecScheme/physicalQubitsPerLogicalQubit",
    input.jobParams.qecScheme.physicalQubitsPerLogicalQubit,
  );
  r.set(
    "jobParams/qubitParams/tGateErrorRate",
    input.jobParams.qubitParams.tGateErrorRate,
  );
  r.set(
    "logicalCounts/ccixCount",
    formatThousandSep(input.logicalCounts.ccixCount),
  );
  r.set(
    "logicalCounts/cczCount",
    formatThousandSep(input.logicalCounts.cczCount),
  );
  r.set(
    "logicalCounts/measurementCount",
    formatThousandSep(input.logicalCounts.measurementCount),
  );
  r.set(
    "logicalCounts/numQubits",
    formatThousandSep(input.logicalCounts.numQubits),
  );
  r.set(
    "logicalCounts/rotationCount",
    formatThousandSep(input.logicalCounts.rotationCount),
  );
  r.set(
    "logicalCounts/rotationDepth",
    formatThousandSep(input.logicalCounts.rotationDepth),
  );
  r.set("logicalCounts/tCount", formatThousandSep(input.logicalCounts.tCount));
  r.set("logicalQubit/codeDistance", input.logicalQubit.codeDistance);
  r.set(
    "logicalQubit/logicalCyclesPerSecond",
    formatThousandSepF64(input.physicalCounts.breakdown.clockFrequency),
  );

  r.set(
    "logicalQubit/logicalCycleTime",
    formatThousandSep(input.logicalQubit.logicalCycleTime),
  );
  r.set(
    "logicalQubit/physicalQubits",
    formatThousandSep(input.logicalQubit.physicalQubits),
  );
  r.set(
    "physicalCounts/breakdown/algorithmicLogicalDepth",
    formatThousandSep(input.physicalCountsFormatted.algorithmicLogicalDepth),
  );
  r.set(
    "physicalCounts/breakdown/algorithmicLogicalQubits",
    formatThousandSep(input.physicalCounts.breakdown.algorithmicLogicalQubits),
  );
  r.set(
    "physicalCounts/breakdown/cliffordErrorRate",
    input.physicalCounts.breakdown.cliffordErrorRate,
  );
  r.set(
    "physicalCounts/breakdown/logicalDepth",
    formatThousandSep(input.physicalCounts.breakdown.logicalDepth),
  );
  r.set(
    "physicalCounts/breakdown/physicalQubitsForAlgorithm",
    formatThousandSep(
      input.physicalCounts.breakdown.physicalQubitsForAlgorithm,
    ),
  );
  r.set(
    "physicalCounts/breakdown/physicalQubitsForTfactories",
    formatThousandSep(
      input.physicalCounts.breakdown.physicalQubitsForTfactories,
    ),
  );
  r.set(
    "physicalCounts/breakdown/numTfactories",
    formatThousandSep(input.physicalCounts.breakdown.numTfactories),
  );
  r.set(
    "physicalCounts/breakdown/numTfactoryRuns",
    formatThousandSep(input.physicalCounts.breakdown.numTfactoryRuns),
  );
  r.set(
    "physicalCounts/breakdown/numTstates",
    formatThousandSep(input.physicalCounts.breakdown.numTstates),
  );
  r.set(
    "physicalCounts/breakdown/requiredLogicalQubitErrorRate",
    input.physicalCounts.breakdown.requiredLogicalQubitErrorRate,
  );
  r.set(
    "physicalCounts/physicalQubits",
    formatThousandSep(input.physicalCounts.physicalQubits),
  );
  r.set(
    "physicalCounts/runtime",
    formatThousandSep(input.physicalCounts.runtime),
  );
  r.set(
    "physicalCountsFormatted/clockFrequency",
    input.physicalCountsFormatted.clockFrequency,
  );
  r.set(
    "physicalCountsFormatted/errorBudget",
    input.physicalCountsFormatted.errorBudget,
  );
  r.set(
    "physicalCountsFormatted/errorBudgetLogical",
    input.physicalCountsFormatted.errorBudgetLogical,
  );
  r.set(
    "physicalCountsFormatted/errorBudgetRotations",
    input.physicalCountsFormatted.errorBudgetRotations,
  );
  r.set(
    "physicalCountsFormatted/errorBudgetTstates",
    input.physicalCountsFormatted.errorBudgetTstates,
  );
  r.set(
    "physicalCountsFormatted/logicalCycleTime",
    input.physicalCountsFormatted.logicalCycleTime,
  );
  r.set(
    "physicalCountsFormatted/numTsPerRotation",
    input.physicalCountsFormatted.numTsPerRotation,
  );
  r.set(
    "physicalCountsFormatted/requiredLogicalQubitErrorRate",
    input.physicalCountsFormatted.requiredLogicalQubitErrorRate,
  );
  r.set(
    "physicalCountsFormatted/requiredLogicalTstateErrorRate",
    input.physicalCountsFormatted.requiredLogicalTstateErrorRate,
  );
  r.set(
    "physicalCountsFormatted/runtime",
    input.physicalCountsFormatted.runtime,
  );
  r.set(
    "physicalCountsFormatted/tfactoryRuntime",
    input.physicalCountsFormatted.tfactoryRuntime,
  );
  r.set(
    "physicalCountsFormatted/tstateLogicalErrorRate",
    input.physicalCountsFormatted.tstateLogicalErrorRate,
  );
  r.set(
    "tfactory/physicalQubits",
    formatThousandSep(
      input.tfactory == null ? 0 : input.tfactory.physicalQubits,
    ),
  );
  r.set(
    "tfactory/numInputTstates",
    formatThousandSep(
      input.tfactory == null ? 0 : input.tfactory.numInputTstates,
    ),
  );
  r.set(
    "tfactory/numTstates",
    formatThousandSep(input.tfactory == null ? 0 : input.tfactory.numTstates),
  );

  r.set(
    "tfactory/runtime",
    formatThousandSep(input.tfactory == null ? 0 : input.tfactory.runtime),
  );
...
export function CreateReport(result: ReData): ReportData {
  ...
  const map = createPathMap(result);
  ...
  groups.push({ entries: entries, title: "All", alwaysVisible: true });
  ...
  if (result.tfactory != null) {
    ...
    entries.push({
      ...
      explanation: `The T factory takes as input ${formatThousandSep(
        result.tfactory == null ? 0 : result.tfactory.numresultTstates,
