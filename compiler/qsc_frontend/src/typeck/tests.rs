...
#[test]
fn stressing_generic_inference() {
    check(
        indoc! {r#"
            namespace Test {
                ...
                function nested_swaps() : Unit {
                    // let a = swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(_)))))))))))))));
                    let a = swap(swap(swap(swap(_))));
                }
            }
        "#},
        "",
        &expect![[r##"
            #8 44-94 "(op : ('T1, 'T2) -> ('T2, 'T1), input: ('T1, 'T2))" : (((Param<"'T1": 0>, Param<"'T2": 1>) -> (Param<"'T2": 1>, Param<"'T1": 0>)), (Param<"'T1": 0>, Param<"'T2": 1>))
            #9 45-74 "op : ('T1, 'T2) -> ('T2, 'T1)" : ((Param<"'T1": 0>, Param<"'T2": 1>) -> (Param<"'T2": 1>, Param<"'T1": 0>))
            #22 76-93 "input: ('T1, 'T2)" : (Param<"'T1": 0>, Param<"'T2": 1>)
            #34 108-133 "{\n        op(input)\n    }" : (Param<"'T2": 1>, Param<"'T1": 0>)
            #36 118-127 "op(input)" : (Param<"'T2": 1>, Param<"'T1": 0>)
            #37 118-120 "op" : ((Param<"'T1": 0>, Param<"'T2": 1>) -> (Param<"'T2": 1>, Param<"'T1": 0>))
            #40 120-127 "(input)" : (Param<"'T1": 0>, Param<"'T2": 1>)
            #41 121-126 "input" : (Param<"'T1": 0>, Param<"'T2": 1>)
            #47 159-161 "()" : Unit
            #51 169-331 "{\n        // let a = swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(swap(_)))))))))))))));\n        let a = swap(swap(swap(swap(_))));\n    }" : Unit
            #53 295-296 "a" : (?2, ?1)
            #55 299-324 "swap(swap(swap(swap(_))))" : (?2, ?1)
            #56 299-303 "swap" : ((((?1, ?2) -> (?2, ?1)), (?1, ?2)) -> (?2, ?1))
            #59 303-324 "(swap(swap(swap(_))))" : (((?1, ?2) -> (?2, ?1)), (?1, ?2))
            #60 304-323 "swap(swap(swap(_)))" : (((?1, ?2) -> (?2, ?1)), (?1, ?2))
            #61 304-308 "swap" : (((((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))), ((?1, ?2), ((?1, ?2) -> (?2, ?1)))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2)))
            #64 308-323 "(swap(swap(_)))" : ((((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))), ((?1, ?2), ((?1, ?2) -> (?2, ?1))))
            #65 309-322 "swap(swap(_))" : ((((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))), ((?1, ?2), ((?1, ?2) -> (?2, ?1))))
            #66 309-313 "swap" : ((((((?1, ?2), ((?1, ?2) -> (?2, ?1))), (((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2)))) -> ((((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))), ((?1, ?2), ((?1, ?2) -> (?2, ?1))))), (((?1, ?2), ((?1, ?2) -> (?2, ?1))), (((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))))) -> ((((?1, ?2), ((?1, ?2) -> (?2, ?1))) -> (((?1, ?2) -> (?2, ?1)), (?1, ?2))), ((?1, ?2), ((?1, ?2) -> (?2, ?1)))))
            #69 313-322 "(swap(_))" : ((((?7, ?8) -> (?8, ?7)), (?7, ?8)) -> (?8, ?7))
            #70 314-321 "swap(_)" : ((((?7, ?8) -> (?8, ?7)), (?7, ?8)) -> (?8, ?7))
            #71 314-318 "swap" : ((((?7, ?8) -> (?8, ?7)), (?7, ?8)) -> (?8, ?7))
            #74 318-321 "(_)" : (((?7, ?8) -> (?8, ?7)), (?7, ?8))
            #75 319-320 "_" : (((?7, ?8) -> (?8, ?7)), (?7, ?8))
            Error(Type(Error(TyMismatch("(((?, ?) -> (?, ?)), (?, ?))", "((((?, ?) -> (?, ?)), (?, ?)) -> (?, ?))", Span { lo: 309, hi: 322 }))))
            Error(Type(Error(AmbiguousTy(Span { lo: 299, hi: 303 }))))
            Error(Type(Error(AmbiguousTy(Span { lo: 299, hi: 303 }))))
            Error(Type(Error(AmbiguousTy(Span { lo: 314, hi: 318 }))))
            Error(Type(Error(AmbiguousTy(Span { lo: 314, hi: 318 }))))
        "##]],
    );
}
