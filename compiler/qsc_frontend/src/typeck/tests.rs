...
fn partial_app_one_missing() {
    check(
        ...
        &expect![[r##"
            ...
            #25 86-92 "Foo(_)" : (Int -> Int)
            #27 86-92 "Foo(_)" : (Int -> Int)
            #20 86-92 "Foo(_)" : (Int,)
            #17 90-91 "_" : Int
            #23 86-92 "Foo(_)" : Int
            #19 86-92 "Foo(_)" : Int
...
fn partial_app_two_missing() {
    check(
        ...
        &expect![[r##"
            ...
            #35 99-108 "Foo(_, _)" : ((Int, Int) -> Int)
            #37 99-108 "Foo(_, _)" : ((Int, Int) -> Int)
            #30 99-108 "Foo(_, _)" : ((Int, Int),)
            #28 102-108 "(_, _)" : (Int, Int)
            #22 103-104 "_" : Int
            #25 106-107 "_" : Int
            #33 99-108 "Foo(_, _)" : Int
            #29 99-108 "Foo(_, _)" : Int
            #20 99-102 "Foo" : ((Int, Int) -> Int)
            #27 102-108 "(_, _)" : (Int, Int)
            #23 103-104 "_" : Int
            #26 106-107 "_" : Int
        "##]],
    );
