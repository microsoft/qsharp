...
fn partial_ap_one_present_one_missing() {
    check(
        ...
        &expect![[r##"
            ...
            #29 99-108 "Foo(2, _)" : Int
            #30 99-102 "Foo" : ((Int, Int) -> Int)
            #28 102-108 "(2, _)" : (Int, Int)
            #24 103-104 "2" : Int
            #27 106-107 "_" : Int
        "##]],
    );
...
fn partial_ap_two_missing() {
    check(
        ...
        &expect![[r##"
            ...
            #19 99-108 "Foo(_, _)" : ((Int, Int) -> Int)
            #19 99-108 "Foo(_, _)" : ((Int, Int) -> Int)
            #30 99-108 "Foo(_, _)" : (Int,)
            #26 106-107 "_" : Int
            #21 103-104 "_" : Int
            #24 106-107 "_" : Int
            #33 99-108 "Foo(_, _)" : Int
            #28 99-108 "Foo(_, _)" : Int
            #29 99-102 "Foo" : ((Int, Int) -> Int)
