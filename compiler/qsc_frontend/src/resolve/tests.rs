...
fn spec_param() {
    check(
        ...
        &expect![[r#"
            namespace def0 {
                operation def1(local8 : Qubit) : (Qubit[], Qubit) {
                    controlled (local17, ...) {
                        (local17, local8)
                    }
                }
...
fn spec_param_shadow() {
    check(
        ...
        &expect![[r#"
            namespace def0 {
                operation def1(local8 : Qubit[]) : Qubit[] {
                    controlled (local16, ...) {
                        local16
                    }
                    body ... {
...
fn ty_decl() {
    check(
        ...
        &expect![[r#"
            namespace def0 {
                newtype def1 = Unit;
                function def2(local12 : def1) : Unit {}
            }
        "#]],
    );
}
    ...
    check(
        ...
        &expect![[r#"
            ...
            namespace def4 {
                ...
                function def5(local26 : Alias.A) : Unit {}
            }
...
fn use_qubit() {
    check(
        ...
        &expect![[r#"
            namespace def0 {
                operation def1(local8 : Qubit) : Unit {
                    body intrinsic;
                }
                operation def2() : Unit {
                    use local20 = Qubit();
