...
"#;
    ...
    expect![
        r#"
@EntryPoint()
operation qasm_op() : Microsoft.Quantum.Math.Complex {
...
"#;
    ...
    expect![
        r#"
@EntryPoint()
operation qasm_op() : (BigInt, Int, Int, Int, Double, Bool, Result, Microsoft.Quantum.Math.Complex, Result[]) {
    mutable bi = 0L;
    mutable i = 0;
    mutable ui = 0;
    mutable u = 0;
