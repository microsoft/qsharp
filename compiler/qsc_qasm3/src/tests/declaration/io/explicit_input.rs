...
"#;
    ...
    expect![
        r#"
operation qasm_op(c : Result[]) : Unit {}
"#
    ]
    .assert_eq(&qsharp);
    Ok(())
...
"#;
    ...
    expect![
        r#"
operation qasm_op(c : Microsoft.Quantum.Math.Complex) : Unit {}
"#
    ]
    .assert_eq(&qsharp);
    Ok(())
...
"#;
    ...
    expect![
        r#"
operation qasm_op(f : Double) : Unit {}
"#
    ]
    .assert_eq(&qsharp);
    Ok(())
...
"#;
    ...
    expect![
        r#"
operation qasm_op(i : BigInt) : Unit {}
"#
    ]
    .assert_eq(&qsharp);
    Ok(())
...
"#;
    ...
    expect![
        r#"
operation qasm_op(bi : BigInt, i : Int, ui : Int, u : Int, f : Double, b : Bool, c : Result, cf : Microsoft.Quantum.Math.Complex, b2 : Result[]) : Unit {}
"#
    ]
    .assert_eq(&qsharp);
    Ok(())
