    ...
    fn dynamic_double_with_branch_and_phi_supported() {
        ...
        expect![[r#"
            ...
            block_2:
              br label %block_3
            block_3:
              %var_3 = phi double [0.0, %block_1], [1.0, %block_2]
              call void @__quantum__rt__double_record_output(double %var_3, i8* null)
              ret void
            }
    ...
    fn dynamic_double_intrinsic() {
        ...
        expect![[r#"
            ...
            block_2:
              br label %block_3
            block_3:
              %var_7 = phi double [0.0, %block_1], [1.0, %block_2]
              %var_3 = fadd double 1.0, %var_7
              call void @OpA(double %var_3, %Qubit* inttoptr (i64 0 to %Qubit*))
              %var_4 = fmul double 2.0, %var_7
              call void @__quantum__qis__rx__body(double %var_4, %Qubit* inttoptr (i64 0 to %Qubit*))
              %var_5 = fdiv double %var_7, 3.0
              call void @__quantum__qis__ry__body(double %var_5, %Qubit* inttoptr (i64 0 to %Qubit*))
              %var_6 = fsub double %var_7, 4.0
              call void @__quantum__qis__rz__body(double %var_6, %Qubit* inttoptr (i64 0 to %Qubit*))
              call void @OpA(double %var_7, %Qubit* inttoptr (i64 0 to %Qubit*))
              call void @__quantum__qis__rx__body(double %var_7, %Qubit* inttoptr (i64 0 to %Qubit*))
              call void @__quantum__rt__double_record_output(double %var_7, i8* null)
              ret void
            }
