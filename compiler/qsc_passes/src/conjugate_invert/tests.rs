            ...
            Package:
                ...
                Item 2 [63-216]:
                    ...
                    Callable 6 [63-216] (Operation):
                        ...
                        output: Unit
                        body: Block: Block 9 [84-216] [Type Unit]:
                            Stmt 10 [94-210]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block _id_ [0-0] [Type Unit]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 12 [101-148] [Type Unit]:
                                    Stmt 13 [115-120]: Semi: Expr 14 [115-119] [Type Unit]: Call:
                                        Expr 15 [115-116] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 16 [117-118] [Type Int]: Lit: Int(1)
                                    Stmt 17 [133-138]: Semi: Expr 18 [133-137] [Type Unit]: Call:
                                        Expr 19 [133-134] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 20 [135-136] [Type Int]: Lit: Int(2)
                                Stmt 32 [0-0]: Local (Immutable):
                                    Pat 33 [0-0] [Type Unit]: Bind: Ident 31 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type Unit]: Expr Block: Block 21 [163-210] [Type Unit]:
                                        Stmt 22 [177-182]: Semi: Expr 23 [177-181] [Type Unit]: Call:
                                            Expr 24 [177-178] [Type (Int => Unit is Adj)]: Var: Item 1
                                            Expr 25 [179-180] [Type Int]: Lit: Int(3)
                                        Stmt 26 [195-200]: Semi: Expr 27 [195-199] [Type Unit]: Call:
                                            Expr 28 [195-196] [Type (Int => Unit is Adj)]: Var: Item 1
                                ...
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 12 [101-148] [Type Unit]:
                                    ...
                                    Stmt 13 [115-120]: Semi: Expr 14 [115-119] [Type Unit]: Call:
                                        Expr _id_ [115-116] [Type (Int => Unit is Adj)]: UnOp (Functor Adj):
                                            Expr 15 [115-116] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 16 [117-118] [Type Int]: Lit: Int(1)
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Var: Local 31"#]],
    );
}
                        ...
                        body: Block: Block 9 [83-252] [Type Int]:
                            Stmt 10 [93-234]: Local (Immutable):
                                ...
                                Expr _id_ [0-0] [Type Int]: Expr Block: Block _id_ [0-0] [Type Int]:
                                    Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 14 [110-157] [Type Unit]:
                                        Stmt 15 [124-129]: Semi: Expr 16 [124-128] [Type Unit]: Call:
                                            Expr 17 [124-125] [Type (Int => Unit is Adj)]: Var: Item 1
                                            Expr 18 [126-127] [Type Int]: Lit: Int(1)
                                        Stmt 19 [142-147]: Semi: Expr 20 [142-146] [Type Unit]: Call:
                                            Expr 21 [142-143] [Type (Int => Unit is Adj)]: Var: Item 1
                                    ...
                                    Stmt 38 [0-0]: Local (Immutable):
                                        ...
                                        Expr _id_ [0-0] [Type Int]: Expr Block: Block 23 [172-233] [Type Int]:
                                            Stmt 24 [186-191]: Semi: Expr 25 [186-190] [Type Unit]: Call:
                                                Expr 26 [186-187] [Type (Int => Unit is Adj)]: Var: Item 1
                                                Expr 27 [188-189] [Type Int]: Lit: Int(3)
                                            Stmt 28 [204-209]: Semi: Expr 29 [204-208] [Type Unit]: Call:
                                                Expr 30 [204-205] [Type (Int => Unit is Adj)]: Var: Item 1
            ...
            Package:
                ...
                Item 2 [63-355]:
                    ...
                    Callable 6 [63-355] (Operation):
                        ...
                        input: Pat 8 [74-76] [Type Unit]: Unit
                        output: Unit
                        body: Block: Block 9 [84-355] [Type Unit]:
                            Stmt 10 [94-349]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block _id_ [0-0] [Type Unit]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 12 [101-287] [Type Unit]:
                                    Stmt 13 [115-120]: Semi: Expr 14 [115-119] [Type Unit]: Call:
                                        Expr 15 [115-116] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 16 [117-118] [Type Int]: Lit: Int(0)
                                    Stmt 17 [133-277]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block _id_ [0-0] [Type Unit]:
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 19 [140-199] [Type Unit]:
                                            Stmt 20 [158-163]: Semi: Expr 21 [158-162] [Type Unit]: Call:
                                                Expr 22 [158-159] [Type (Int => Unit is Adj)]: Var: Item 1
                                                Expr 23 [160-161] [Type Int]: Lit: Int(1)
                                            Stmt 24 [180-185]: Semi: Expr 25 [180-184] [Type Unit]: Call:
                                                Expr 26 [180-181] [Type (Int => Unit is Adj)]: Var: Item 1
                                                Expr 27 [182-183] [Type Int]: Lit: Int(2)
                                        Stmt 51 [0-0]: Local (Immutable):
                                            Pat 52 [0-0] [Type Unit]: Bind: Ident 50 [0-0] "apply_res"
                                            Expr _id_ [0-0] [Type Unit]: Expr Block: Block 28 [218-277] [Type Unit]:
                                                Stmt 29 [236-241]: Semi: Expr 30 [236-240] [Type Unit]: Call:
                                                    Expr 31 [236-237] [Type (Int => Unit is Adj)]: Var: Item 1
                                                    Expr 32 [238-239] [Type Int]: Lit: Int(3)
                                                Stmt 33 [258-263]: Semi: Expr 34 [258-262] [Type Unit]: Call:
                                                    Expr 35 [258-259] [Type (Int => Unit is Adj)]: Var: Item 1
                                ...
                                Stmt 48 [0-0]: Local (Immutable):
                                    Pat 49 [0-0] [Type Unit]: Bind: Ident 47 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type Unit]: Expr Block: Block 37 [302-349] [Type Unit]:
                                        Stmt 38 [316-321]: Semi: Expr 39 [316-320] [Type Unit]: Call:
                                            Expr 40 [316-317] [Type (Int => Unit is Adj)]: Var: Item 1
                                            Expr 41 [318-319] [Type Int]: Lit: Int(5)
                                        Stmt 42 [334-339]: Semi: Expr 43 [334-338] [Type Unit]: Call:
                                            Expr 44 [334-335] [Type (Int => Unit is Adj)]: Var: Item 1
                                ...
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 12 [101-287] [Type Unit]:
                                    ...
                                    Stmt 13 [115-120]: Semi: Expr 14 [115-119] [Type Unit]: Call:
                                        Expr _id_ [115-116] [Type (Int => Unit is Adj)]: UnOp (Functor Adj):
                                            Expr 15 [115-116] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 16 [117-118] [Type Int]: Lit: Int(0)
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Var: Local 47"#]],
    );
}
            ...
            Package:
                ...
                Item 2 [63-312]:
                    ...
                    Callable 6 [63-312] (Operation):
                        ...
                        input: Pat 8 [74-76] [Type Unit]: Unit
                        output: Unit
                        body: Block: Block 9 [84-312] [Type Unit]:
                            Stmt 10 [94-108]: Local (Mutable):
                                Pat 11 [102-103] [Type Int]: Bind: Ident 12 [102-103] "a"
                                Expr 13 [106-107] [Type Int]: Lit: Int(1)
                            Stmt 14 [117-306]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block _id_ [0-0] [Type Unit]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type Unit]: Expr Block: Block 16 [124-194] [Type Unit]:
                                    Stmt 17 [138-148]: Local (Immutable):
                                        Pat 18 [142-143] [Type Int]: Bind: Ident 19 [142-143] "x"
                                        Expr 20 [146-147] [Type Int]: Var: Local 12
                                    Stmt 21 [161-166]: Semi: Expr 22 [161-165] [Type Unit]: Call:
                                        Expr 23 [161-162] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 24 [163-164] [Type Int]: Lit: Int(1)
                                    Stmt 25 [179-184]: Semi: Expr 26 [179-183] [Type Unit]: Call:
                                        Expr 27 [179-180] [Type (Int => Unit is Adj)]: Var: Item 1
                                        Expr 28 [181-182] [Type Int]: Lit: Int(2)
                                Stmt 48 [0-0]: Local (Immutable):
                                    Pat 49 [0-0] [Type Unit]: Bind: Ident 47 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type Unit]: Expr Block: Block 29 [209-306] [Type Unit]:
                                        Stmt 30 [223-237]: Local (Mutable):
                                            Pat 31 [231-232] [Type Int]: Bind: Ident 32 [231-232] "b"
                                            Expr 33 [235-236] [Type Int]: Var: Local 12
                                        Stmt 34 [250-260]: Semi: Expr 35 [250-259] [Type Unit]: Assign:
                                            Expr 36 [254-255] [Type Int]: Var: Local 32
                                            Expr 37 [258-259] [Type Int]: Lit: Int(0)
                                        Stmt 38 [273-278]: Semi: Expr 39 [273-277] [Type Unit]: Call:
                                            Expr 40 [273-274] [Type (Int => Unit is Adj)]: Var: Item 1
                                            Expr 41 [275-276] [Type Int]: Lit: Int(3)
                                        Stmt 42 [291-296]: Semi: Expr 43 [291-295] [Type Unit]: Call:
                                            Expr 44 [291-292] [Type (Int => Unit is Adj)]: Var: Item 1
