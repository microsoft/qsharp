            ...
            Package:
                ...
                Item 2 [63-216] (Public):
                    ...
                    Callable 5 [63-216] (Operation):
                        ...
                        input: Pat 7 [74-76] [Type ()]: Unit
                        output: ()
                        functors: 
                        body: Block: Block 8 [84-216] [Type ()]:
                            Stmt 9 [94-210]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block _id_ [0-0] [Type ()]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 11 [101-148] [Type ()]:
                                    Stmt 12 [115-120]: Semi: Expr 13 [115-119] [Type ()]: Call:
                                        Expr 14 [115-116] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 15 [117-118] [Type Int]: Lit: Int(1)
                                    Stmt 16 [133-138]: Semi: Expr 17 [133-137] [Type ()]: Call:
                                        Expr 18 [133-134] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 19 [135-136] [Type Int]: Lit: Int(2)
                                Stmt 31 [0-0]: Local (Immutable):
                                    Pat 32 [0-0] [Type ()]: Bind: Ident 30 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type ()]: Expr Block: Block 20 [163-210] [Type ()]:
                                        Stmt 21 [177-182]: Semi: Expr 22 [177-181] [Type ()]: Call:
                                            Expr 23 [177-178] [Type (Int => () is Adj)]: Var: Item 1
                                            Expr 24 [179-180] [Type Int]: Lit: Int(3)
                                        Stmt 25 [195-200]: Semi: Expr 26 [195-199] [Type ()]: Call:
                                            Expr 27 [195-196] [Type (Int => () is Adj)]: Var: Item 1
                                ...
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 11 [101-148] [Type ()]:
                                    ...
                                    Stmt 12 [115-120]: Semi: Expr 13 [115-119] [Type ()]: Call:
                                        Expr _id_ [115-116] [Type (Int => () is Adj)]: UnOp (Functor Adj):
                                            Expr 14 [115-116] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 15 [117-118] [Type Int]: Lit: Int(1)
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Var: Local 30"#]],
    );
}
                        ...
                        body: Block: Block 8 [83-252] [Type Int]:
                            Stmt 9 [93-234]: Local (Immutable):
                                ...
                                Expr _id_ [0-0] [Type Int]: Expr Block: Block _id_ [0-0] [Type Int]:
                                    Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 13 [110-157] [Type ()]:
                                        Stmt 14 [124-129]: Semi: Expr 15 [124-128] [Type ()]: Call:
                                            Expr 16 [124-125] [Type (Int => () is Adj)]: Var: Item 1
                                    ...
                                    Stmt 37 [0-0]: Local (Immutable):
                                        ...
                                        Expr _id_ [0-0] [Type Int]: Expr Block: Block 22 [172-233] [Type Int]:
                                            Stmt 23 [186-191]: Semi: Expr 24 [186-190] [Type ()]: Call:
                                                Expr 25 [186-187] [Type (Int => () is Adj)]: Var: Item 1
                                                Expr 26 [188-189] [Type Int]: Lit: Int(3)
                                            Stmt 27 [204-209]: Semi: Expr 28 [204-208] [Type ()]: Call:
                                                Expr 29 [204-205] [Type (Int => () is Adj)]: Var: Item 1
            ...
            Package:
                ...
                Item 2 [63-355] (Public):
                    ...
                    Callable 5 [63-355] (Operation):
                        ...
                        output: ()
                        functors: 
                        body: Block: Block 8 [84-355] [Type ()]:
                            Stmt 9 [94-349]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block _id_ [0-0] [Type ()]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 11 [101-287] [Type ()]:
                                    Stmt 12 [115-120]: Semi: Expr 13 [115-119] [Type ()]: Call:
                                        Expr 14 [115-116] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 15 [117-118] [Type Int]: Lit: Int(0)
                                    Stmt 16 [133-277]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block _id_ [0-0] [Type ()]:
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 18 [140-199] [Type ()]:
                                            Stmt 19 [158-163]: Semi: Expr 20 [158-162] [Type ()]: Call:
                                                Expr 21 [158-159] [Type (Int => () is Adj)]: Var: Item 1
                                                Expr 22 [160-161] [Type Int]: Lit: Int(1)
                                            Stmt 23 [180-185]: Semi: Expr 24 [180-184] [Type ()]: Call:
                                                Expr 25 [180-181] [Type (Int => () is Adj)]: Var: Item 1
                                                Expr 26 [182-183] [Type Int]: Lit: Int(2)
                                        Stmt 50 [0-0]: Local (Immutable):
                                            Pat 51 [0-0] [Type ()]: Bind: Ident 49 [0-0] "apply_res"
                                            Expr _id_ [0-0] [Type ()]: Expr Block: Block 27 [218-277] [Type ()]:
                                                Stmt 28 [236-241]: Semi: Expr 29 [236-240] [Type ()]: Call:
                                                    Expr 30 [236-237] [Type (Int => () is Adj)]: Var: Item 1
                                                    Expr 31 [238-239] [Type Int]: Lit: Int(3)
                                                Stmt 32 [258-263]: Semi: Expr 33 [258-262] [Type ()]: Call:
                                                    Expr 34 [258-259] [Type (Int => () is Adj)]: Var: Item 1
                                        ...
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 18 [140-199] [Type ()]:
                                            ...
                                            Stmt 19 [158-163]: Semi: Expr 20 [158-162] [Type ()]: Call:
                                                Expr _id_ [158-159] [Type (Int => () is Adj)]: UnOp (Functor Adj):
                                                    Expr 21 [158-159] [Type (Int => () is Adj)]: Var: Item 1
                                                Expr 22 [160-161] [Type Int]: Lit: Int(1)
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Var: Local 49
                                Stmt 47 [0-0]: Local (Immutable):
                                    Pat 48 [0-0] [Type ()]: Bind: Ident 46 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type ()]: Expr Block: Block 36 [302-349] [Type ()]:
                                        Stmt 37 [316-321]: Semi: Expr 38 [316-320] [Type ()]: Call:
                                            Expr 39 [316-317] [Type (Int => () is Adj)]: Var: Item 1
                                            Expr 40 [318-319] [Type Int]: Lit: Int(5)
                                        Stmt 41 [334-339]: Semi: Expr 42 [334-338] [Type ()]: Call:
                                            Expr 43 [334-335] [Type (Int => () is Adj)]: Var: Item 1
                                ...
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 11 [101-287] [Type ()]:
                                    Stmt 16 [133-277]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block _id_ [0-0] [Type ()]:
                                        ...
                                        Stmt 53 [0-0]: Local (Immutable):
                                            Pat 54 [0-0] [Type ()]: Bind: Ident 52 [0-0] "apply_res"
                                            Expr _id_ [0-0] [Type ()]: Expr Block: Block 27 [218-277] [Type ()]:
                                                Stmt 32 [258-263]: Semi: Expr 33 [258-262] [Type ()]: Call:
                                        ...
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 18 [140-199] [Type ()]:
                                            ...
                                            Stmt 19 [158-163]: Semi: Expr 20 [158-162] [Type ()]: Call:
                                                Expr _id_ [158-159] [Type (Int => () is Adj)]: UnOp (Functor Adj):
                                                    Expr 21 [158-159] [Type (Int => () is Adj)]: Var: Item 1
                                                Expr 22 [160-161] [Type Int]: Lit: Int(1)
                                        Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Var: Local 52
                                    Stmt 12 [115-120]: Semi: Expr 13 [115-119] [Type ()]: Call:
                                        Expr _id_ [115-116] [Type (Int => () is Adj)]: UnOp (Functor Adj):
                                            Expr 14 [115-116] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 15 [117-118] [Type Int]: Lit: Int(0)
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Var: Local 46"#]],
    );
}
            ...
            Package:
                ...
                Item 2 [63-312] (Public):
                    ...
                    Callable 5 [63-312] (Operation):
                        ...
                        output: ()
                        functors: 
                        body: Block: Block 8 [84-312] [Type ()]:
                            Stmt 9 [94-108]: Local (Mutable):
                                Pat 10 [102-103] [Type Int]: Bind: Ident 11 [102-103] "a"
                                Expr 12 [106-107] [Type Int]: Lit: Int(1)
                            Stmt 13 [117-306]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block _id_ [0-0] [Type ()]:
                                Stmt _id_ [0-0]: Expr: Expr _id_ [0-0] [Type ()]: Expr Block: Block 15 [124-194] [Type ()]:
                                    Stmt 16 [138-148]: Local (Immutable):
                                        Pat 17 [142-143] [Type Int]: Bind: Ident 18 [142-143] "x"
                                        Expr 19 [146-147] [Type Int]: Var: Local 11
                                    Stmt 20 [161-166]: Semi: Expr 21 [161-165] [Type ()]: Call:
                                        Expr 22 [161-162] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 23 [163-164] [Type Int]: Lit: Int(1)
                                    Stmt 24 [179-184]: Semi: Expr 25 [179-183] [Type ()]: Call:
                                        Expr 26 [179-180] [Type (Int => () is Adj)]: Var: Item 1
                                        Expr 27 [181-182] [Type Int]: Lit: Int(2)
                                Stmt 47 [0-0]: Local (Immutable):
                                    Pat 48 [0-0] [Type ()]: Bind: Ident 46 [0-0] "apply_res"
                                    Expr _id_ [0-0] [Type ()]: Expr Block: Block 28 [209-306] [Type ()]:
                                        Stmt 29 [223-237]: Local (Mutable):
                                            Pat 30 [231-232] [Type Int]: Bind: Ident 31 [231-232] "b"
                                            Expr 32 [235-236] [Type Int]: Var: Local 11
                                        Stmt 33 [250-260]: Semi: Expr 34 [250-259] [Type ()]: Assign:
                                            Expr 35 [254-255] [Type Int]: Var: Local 31
                                            Expr 36 [258-259] [Type Int]: Lit: Int(0)
                                        Stmt 37 [273-278]: Semi: Expr 38 [273-277] [Type ()]: Call:
                                            Expr 39 [273-274] [Type (Int => () is Adj)]: Var: Item 1
                                            Expr 40 [275-276] [Type Int]: Lit: Int(3)
                                        Stmt 41 [291-296]: Semi: Expr 42 [291-295] [Type ()]: Call:
                                            Expr 43 [291-292] [Type (Int => () is Adj)]: Var: Item 1
