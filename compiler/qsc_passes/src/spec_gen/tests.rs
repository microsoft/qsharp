                ...
                Item 1 [21-68] (Public):
                    ...
                    Callable 0 [21-68] (Operation):
                        ...
                        body: Specializations:
                            ...
                            SpecDecl _id_ [21-68] (Ctl): Impl:
                                Pat _id_ [21-68] [Type ((Qubit)[], Int)]: Tuple:
                                    Pat _id_ [21-68] [Type (Qubit)[]]: Bind: Ident 42 [21-68] "ctls"
                                    Pat _id_ [21-68] [Type Int]: Elided
                                Block 4 [66-68]: <empty>
                            SpecDecl _id_ [21-68] (CtlAdj): Impl:
                                Pat _id_ [21-68] [Type ((Qubit)[], Int)]: Tuple:
                                    Pat _id_ [21-68] [Type (Qubit)[]]: Bind: Ident 43 [21-68] "ctls"
                                    Pat _id_ [21-68] [Type Int]: Elided
                                Block 4 [66-68]: <empty>
                Item 2 [73-270] (Public):
                    Parent: 0
                    Callable 5 [73-270] (Operation):
                        name: Ident 6 [83-84] "A"
                        input: Pat 7 [85-94] [Type Qubit]: Bind: Ident 8 [85-86] "q"
                        output: Unit
                        functors: Adj + Ctl
                                ...
                                Block 11 [135-150] [Type Unit]:
                                    ...
                                    Stmt 12 [137-142]: Semi: Expr 13 [137-141] [Type Unit]: Call:
                                        Expr _id_ [137-138] [Type (Int => Unit is Adj + Ctl)]: UnOp (Functor Adj):
                                            Expr 14 [137-138] [Type (Int => Unit is Adj + Ctl)]: Var: Item 1
                                        Expr 15 [139-140] [Type Int]: Lit: Int(1)
                            SpecDecl 20 [159-231] (Ctl): Impl:
                                Pat 21 [170-181] [Type ((Qubit)[], Qubit)]: Tuple:
                                    Pat 22 [171-175] [Type (Qubit)[]]: Bind: Ident 23 [171-175] "ctls"
                                    Pat 24 [177-180] [Type Qubit]: Elided
                                Block 25 [182-231] [Type Unit]:
                                    Stmt 26 [184-206]: Semi: Expr 27 [184-205] [Type Unit]: Call:
                                        Expr 28 [184-196] [Type (((Qubit)[], Int) => Unit is Adj + Ctl)]: UnOp (Functor Ctl):
                                            Expr 29 [195-196] [Type (Int => Unit is Adj + Ctl)]: Var: Item 1
                                        Expr 30 [196-205] [Type ((Qubit)[], Int)]: Tuple:
                                            Expr 31 [197-201] [Type (Qubit)[]]: Var: Local 23
                                            Expr 32 [203-204] [Type Int]: Lit: Int(1)
                                    Stmt 33 [207-229]: Semi: Expr 34 [207-228] [Type Unit]: Call:
                                        Expr 35 [207-219] [Type (((Qubit)[], Int) => Unit is Adj + Ctl)]: UnOp (Functor Ctl):
                                            Expr 36 [218-219] [Type (Int => Unit is Adj + Ctl)]: Var: Item 1
                                        Expr 37 [219-228] [Type ((Qubit)[], Int)]: Tuple:
                                            Expr 38 [220-224] [Type (Qubit)[]]: Var: Local 23
                                            Expr 39 [226-227] [Type Int]: Lit: Int(2)
                            SpecDecl _id_ [73-270] (CtlAdj): Impl:
                                Pat 21 [170-181] [Type ((Qubit)[], Qubit)]: Tuple:
                                    Pat 22 [171-175] [Type (Qubit)[]]: Bind: Ident 23 [171-175] "ctls"
                                    Pat 24 [177-180] [Type Qubit]: Elided
                                Block 25 [182-231] [Type Unit]:
