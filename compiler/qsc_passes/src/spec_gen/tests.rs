...
fn generate_ctl() {
    check(
        ...
        &expect![[r#"
            Package 35:
                Item 33 [0-184]:
                    Namespace (Ident 34 [10-14] "test"): [LocalItemId(1), LocalItemId(2)]
                Item 0 [21-119]:
                            ...
                            SpecDecl 36 [161-182] (Body): Impl:
                                ...
                                Block 27 [161-182]:
                                    Stmt 28 [171-176]: Semi: Expr 29 [171-175]: Call:
                                        Expr 30 [171-172]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
...
fn generate_ctladj_distrib() {
    check(
        ...
        &expect![[r#"
            Package 53:
                Item 51 [0-310]:
                    Namespace (Ident 52 [10-14] "test"): [LocalItemId(1), LocalItemId(2)]
                Item 0 [21-148]:
                            ...
                            SpecDecl 34 [206-244] (Body): Impl:
                                ...
                                Block 36 [215-244]:
                                    Stmt 37 [229-234]: Semi: Expr 38 [229-233]: Call:
                                        Expr 39 [229-230]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
                                ...
                                Block 44 [265-302]:
                                    Stmt 45 [279-292]: Semi: Expr 46 [279-291]: Call:
                                        Expr 47 [279-288]: UnOp (Functor Adj):
                                            Expr 48 [287-288]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
...
fn generate_ctl_skip_conjugate_apply_block() {
    check(
        ...
        &expect![[r#"
            Package 44:
                Item 42 [0-259]:
                    Namespace (Ident 43 [10-14] "test"): [LocalItemId(1), LocalItemId(2)]
                Item 0 [21-119]:
                    Callable 1 [21-119] (Operation):
                        name: Ident 2 [31-32] "A"
                        input: Pat 3 [32-43]: Paren:
                                    ...
                                    Stmt 28 [171-251]: Expr: Expr 29 [171-251]: Conjugate:
                                        Block 30 [178-207]:
                                            Stmt 31 [192-197]: Semi: Expr 32 [192-196]: Call:
                                                Expr 33 [192-193]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
                                                Expr 34 [193-196]: Paren: Expr 35 [194-195]: Name: Local(NodeId(23))
                                        Block 36 [222-251]:
                                            Stmt 37 [236-241]: Semi: Expr 38 [236-240]: Call:
                                                Expr 39 [236-237]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
...
fn generate_ctl_with_function_calls() {
    check(
        ...
        &expect![[r#"
            Package 30:
                Item 28 [0-150]:
                    Namespace (Ident 29 [10-14] "test"): [LocalItemId(1), LocalItemId(2), LocalItemId(3)]
                Item 0 [21-45]:
                            ...
                            SpecDecl 34 [113-148] (Body): Impl:
                                ...
                                Block 19 [113-148]:
                                    Stmt 20 [123-129]: Semi: Expr 21 [123-128]: Call:
                                        Expr 22 [123-126]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
                                        Expr 23 [126-128]: Unit
                                    Stmt 24 [138-142]: Semi: Expr 25 [138-141]: Call:
                                        Expr 26 [138-139]: Name: Item(ItemId { package: None, item: LocalItemId(2) })
                            ...
                            SpecDecl 19 [114-138] (Body): Impl:
                                ...
                                Block 21 [123-138]:
                                    Stmt 22 [125-130]: Semi: Expr 23 [125-129]: Call:
                                        Expr 24 [125-126]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
                                        Expr 25 [126-129]: Paren: Expr 26 [127-128]: Lit: Int(1)
                                    Stmt 27 [131-136]: Semi: Expr 28 [131-135]: Call:
                                        Expr 29 [131-132]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
...
fn generate_ctladj_self() {
    check(
        ...
        &expect![[r#"
            Package 39:
                Item 37 [0-180]:
                    Namespace (Ident 38 [10-14] "test"): [LocalItemId(1), LocalItemId(2)]
                Item 0 [21-68]:
                            ...
                            SpecDecl 23 [126-150] (Body): Impl:
                                ...
                                Block 25 [135-150]:
                                    Stmt 26 [137-142]: Semi: Expr 27 [137-141]: Call:
                                        Expr 28 [137-138]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
                                        Expr 29 [138-141]: Paren: Expr 30 [139-140]: Lit: Int(1)
                                    Stmt 31 [143-148]: Semi: Expr 32 [143-147]: Call:
                                        Expr 33 [143-144]: Name: Item(ItemId { package: None, item: LocalItemId(1) })
