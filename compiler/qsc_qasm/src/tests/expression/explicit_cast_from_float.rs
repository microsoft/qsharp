...
fn float_to_angle() {
    ...
    check(
        ...
        &expect![[r#"
            import QasmStd.Intrinsic.*;
            mutable a = 0.;
            QasmStd.Angle.DoubleAsAngle(a, 53);
        "#]],
    );
}
...
fn float_to_sized_angle() {
    ...
    check(
        ...
        &expect![[r#"
            import QasmStd.Intrinsic.*;
            mutable a = 0.;
            QasmStd.Angle.DoubleAsAngle(a, 32);
        "#]],
    );
}
...
fn sized_float_to_sized_angle_truncating() {
    ...
    check(
        ...
        &expect![[r#"
            import QasmStd.Intrinsic.*;
            mutable a = 0.;
            QasmStd.Angle.DoubleAsAngle(a, 16);
        "#]],
    );
}
...
fn sized_float_to_sized_angle_expanding() {
    ...
    check(
        ...
        &expect![[r#"
            import QasmStd.Intrinsic.*;
            mutable a = 0.;
            QasmStd.Angle.DoubleAsAngle(a, 64);
        "#]],
    );
}
...
fn float_to_bit() {
    ...
    check(
        ...
        &expect![[r#"
            import QasmStd.Intrinsic.*;
            mutable a = 0.;
            QasmStd.Convert.DoubleAsResult(a);
        "#]],
    );
}
