    ...
    expect![[r#"
        namespace qasm_import {
            ...
            operation Test() : (Result[], Result[], Result[], Result[], Result[]) {
                ...
                set ls_a_1 = (Std.Qasm.Convert.IntAsResultArrayBE(Std.Qasm.Convert.ResultArrayAsIntBE(a) <<< 1, 8));
                mutable a_or_b = [Zero, Zero, Zero, Zero, Zero, Zero, Zero, Zero];
                set a_or_b = (Std.Qasm.Convert.IntAsResultArrayBE(Std.Qasm.Convert.ResultArrayAsIntBE(a) ||| Std.Qasm.Convert.ResultArrayAsIntBE(b), 8));
                mutable a_and_b = [Zero, Zero, Zero, Zero, Zero, Zero, Zero, Zero];
                set a_and_b = (Std.Qasm.Convert.IntAsResultArrayBE(Std.Qasm.Convert.ResultArrayAsIntBE(a) &&& Std.Qasm.Convert.ResultArrayAsIntBE(b), 8));
                mutable a_xor_b = [Zero, Zero, Zero, Zero, Zero, Zero, Zero, Zero];
                set a_xor_b = (Std.Qasm.Convert.IntAsResultArrayBE(Std.Qasm.Convert.ResultArrayAsIntBE(a) ^^^ Std.Qasm.Convert.ResultArrayAsIntBE(b), 8));
                mutable rs_a_1 = [Zero, Zero, Zero, Zero, Zero, Zero, Zero, Zero];
                set rs_a_1 = (Std.Qasm.Convert.IntAsResultArrayBE(Std.Qasm.Convert.ResultArrayAsIntBE(a) >>> 1, 8));
