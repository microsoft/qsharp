...
fn to_bit_and_back_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        mutable _bit1 = Zero;
        set _bit0 = One;
        set _bit1 = Std.Qasm.Convert.BoolAsResult(a);
        set _bit0 = _bit1;
        set _bit0 = _bit1;
        set a = Std.Qasm.Convert.ResultAsBool(_bit1);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_bit_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = true;
        mutable y = Std.Qasm.Convert.BoolAsResult(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_implicit_int_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = true;
        mutable y = Std.Qasm.Convert.BoolAsInt(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_explicit_bigint_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = true;
        mutable y = Std.Qasm.Convert.BoolAsBigInt(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_implicit_float_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = true;
        mutable y = Std.Qasm.Convert.BoolAsDouble(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
