...
fn to_bool_and_back_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        set _bool0 = true;
        set _bool1 = Std.Qasm.Convert.ResultAsBool(a);
        set _bool0 = _bool1;
        set _bool0 = _bool1;
        set a = Std.Qasm.Convert.BoolAsResult(_bool1);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_bool_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = One;
        mutable y = Std.Qasm.Convert.ResultAsBool(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_implicit_int_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = One;
        mutable y = Std.Qasm.Convert.ResultAsInt(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn to_explicit_bigint_implicitly() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        mutable x = One;
        mutable y = Std.Qasm.Convert.ResultAsBigInt(x);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
