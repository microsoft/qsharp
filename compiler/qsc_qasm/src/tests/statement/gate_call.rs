...
fn u_gate_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        U(Std.Qasm.Angle.DoubleAsAngle(1., 53), Std.Qasm.Angle.DoubleAsAngle(2., 53), Std.Qasm.Angle.DoubleAsAngle(3., 53), q);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn gphase_gate_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        gphase(Std.Qasm.Angle.DoubleAsAngle(2., 53));
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn custom_gates_can_be_called_bypassing_stdgates() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        operation h(a : Qubit) : Unit is Adj + Ctl {
            U(Std.Qasm.Angle.DoubleAsAngle(3.141592653589793 / 2., 53), Std.Qasm.Angle.DoubleAsAngle(0., 53), Std.Qasm.Angle.DoubleAsAngle(3.141592653589793, 53), a);
            gphase(Std.Qasm.Angle.DoubleAsAngle(-3.141592653589793 / 4., 53));
        }
        operation x(a : Qubit) : Unit is Adj + Ctl {
            U(Std.Qasm.Angle.DoubleAsAngle(3.141592653589793, 53), Std.Qasm.Angle.DoubleAsAngle(0., 53), Std.Qasm.Angle.DoubleAsAngle(3.141592653589793, 53), a);
            gphase(Std.Qasm.Angle.DoubleAsAngle(-3.141592653589793 / 2., 53));
        }
        operation cx(a : Qubit, b : Qubit) : Unit is Adj + Ctl {
            Controlled x([a], b);
        }
        operation rz(λ : Std.Qasm.Angle.Angle, a : Qubit) : Unit is Adj + Ctl {
            gphase(Std.Qasm.Angle.DivideAngleByInt(Std.Qasm.Angle.NegAngle(λ), 2));
            U(Std.Qasm.Angle.DoubleAsAngle(0., 53), Std.Qasm.Angle.DoubleAsAngle(0., 53), λ, a);
        }
        operation rxx(theta : Std.Qasm.Angle.Angle, a : Qubit, b : Qubit) : Unit is Adj + Ctl {
            h(a);
            h(b);
            cx(a, b);
            rz(theta, b);
        ...
        x(a);
        rxx(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), a, b);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn rx_gate_with_one_angle_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        let q = QIR.Runtime.__quantum__rt__qubit_allocate();
        rx(Std.Qasm.Angle.DoubleAsAngle(2., 53), q);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn implicit_cast_to_angle_works() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        let q = QIR.Runtime.__quantum__rt__qubit_allocate();
        mutable a = 2.;
        rx(Std.Qasm.Angle.DoubleAsAngle(a, 53), q);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn rxx_gate_with_one_angle_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        let q = QIR.Runtime.AllocateQubitArray(2);
        rxx(Std.Qasm.Angle.DoubleAsAngle(2., 53), q[1], q[0]);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn ryy_gate_with_one_angle_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        let q = QIR.Runtime.AllocateQubitArray(2);
        ryy(Std.Qasm.Angle.DoubleAsAngle(2., 53), q[1], q[0]);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn rzz_gate_with_one_angle_can_be_called() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        import Std.Qasm.Intrinsic.*;
        let q = QIR.Runtime.AllocateQubitArray(2);
        rzz(Std.Qasm.Angle.DoubleAsAngle(2., 53), q[1], q[0]);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
}
...
fn all_qiskit_stdgates_can_be_called_included() -> miette::Result<(), Vec<Report>> {
    ...
    expect![[r#"
        ...
        rxx(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), q[1], q[0]);
        ryy(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), q[1], q[0]);
        rzz(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), q[1], q[0]);
        dcx(q[0], q[1]);
        ecr(q[0], q[1]);
        r(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 4., 53), q[1]);
        rzx(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), q[1], q[0]);
        cs(q[0], q[1]);
        csdg(q[0], q[1]);
        sxdg(q[0]);
        csx(q[0], q[1]);
        cu1(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), q[1], q[0]);
        cu3(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 4., 53), Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 8., 53), q[1], q[0]);
        rccx(q[0], q[1], q[2]);
        c3sqrtx(q[0], q[1], q[2], q[3]);
        c3x(q[0], q[1], q[2], q[3]);
        rc3x(q[0], q[1], q[2], q[3]);
        xx_minus_yy(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 4., 53), q[1], q[0]);
        xx_plus_yy(Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 2., 53), Std.Qasm.Angle.DoubleAsAngle(Std.Math.PI() / 4., 53), q[1], q[0]);
        ccz(q[0], q[1], q[2]);
    "#]]
    .assert_eq(&qsharp);
    Ok(())
