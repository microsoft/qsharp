...
/// There should always be at leat 2 integer bits in the fixed-point number. The first one represents the sign, the second one is the most significant bit of the int.
