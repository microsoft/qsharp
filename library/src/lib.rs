...
pub const STD_LIB: &[(&str, &str)] = &[
    (
        ...
        include_str!("../qs_source/std/src/std/arrays.qs"),
    ),
    (
        "qsharp-library-source:canon.qs",
        include_str!("../qs_source/std/src/std/canon.qs"),
    ),
    (
        "qsharp-library-source:convert.qs",
        include_str!("../qs_source/std/src/std/convert.qs"),
    ),
    (
        "qsharp-library-source:core.qs",
        include_str!("../qs_source/std/src/std/core.qs"),
    ),
    (
        "qsharp-library-source:diagnostics.qs",
        include_str!("../qs_source/std/src/std/diagnostics.qs"),
    ),
    (
        "qsharp-library-source:internal.qs",
        include_str!("../qs_source/std/src/std/internal.qs"),
    ),
    (
        "qsharp-library-source:intrinsic.qs",
        include_str!("../qs_source/std/src/std/intrinsic.qs"),
    ),
    (
        "qsharp-library-source:logical.qs",
        include_str!("../qs_source/std/src/std/logical.qs"),
    ),
    (
        "qsharp-library-source:math.qs",
        include_str!("../qs_source/std/src/std/math.qs"),
    ),
    (
        "qsharp-library-source:measurement.qs",
        include_str!("../qs_source/std/src/std/measurement.qs"),
    ),
    (
        "qsharp-library-source:qir.qs",
        include_str!("../qs_source/std/src/std/qir.qs"),
    ),
    (
        "qsharp-library-source:random.qs",
        include_str!("../qs_source/std/src/std/random.qs"),
    ),
    (
