...
namespace Microsoft.Quantum.Arrays {
    ...
    function Interleaved<'T>(first : 'T[], second : 'T[]) : 'T[] {
        ...
        for index in 0..interleavedLength - 1 {
            ...
            let value = if index % 2 == 0 { first[originalIndex] } else { second[originalIndex] };
    ...
    export All, Any, Chunks, CircularlyShifted, ColumnAt, Count, Diagonal, DrawMany, Enumerated, Excluding, Filtered, FlatMapped, Flattened, Fold, ForEach, Head, HeadAndRest, IndexOf, IndexRange, Interleaved, IsEmpty, IsRectangularArray, IsSorted, IsSquareArray, Mapped, MappedByIndex, MappedOverRange, Most, MostAndTail, Padded, Partitioned, Rest, Reversed, SequenceI, SequenceL, Sorted, Subarray, Swapped, Transposed, Tail, Unzipped, Where, Windows, Zipped;
}
