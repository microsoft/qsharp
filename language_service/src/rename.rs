...
use qsc::{
    ast::{
        self,
        visit::{walk_callable_decl, walk_expr, walk_pat, walk_ty_def, Visitor},
    },
    hir, resolve, Span,
};
...
use crate::{
    ...
    qsc_utils::{find_ident, find_item, map_offset, span_contains, Compilation},
};
