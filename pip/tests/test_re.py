...
class TestQSharpEstimation:
    def test_qsharp_estimation(self, mock_urlopen) -> None:
        print(mock_urlopen)
    ...
    def test_qsharp_estimation_from_precalculated_counts(self, mock_urlopen) -> None:
        qsharp.init(target_profile=qsharp.TargetProfile.Unrestricted)
        res = qsharp.estimate(
            """{{
    ...
    def test_qsharp_estimation_with_single_params(self, mock_urlopen) -> None:
        qsharp.init(target_profile=qsharp.TargetProfile.Unrestricted)
    ...
    def test_qsharp_estimation_with_multiple_params(self, mock_urlopen) -> None:
        qsharp.init(target_profile=qsharp.TargetProfile.Unrestricted)
    ...
    def test_estimation_from_logical_counts(self, mock_urlopen) -> None:
    ...
    def test_estimation_from_logical_counts_with_single_params(self, mock_urlopen) -> None:
        logical_counts = LogicalCounts(
            {
                "numQubits": 12581,
                "tCount": 12,
    ...
    def test_estimation_from_logical_counts_with_multiple_params(self, mock_urlopen) -> None:
        logical_counts = LogicalCounts(
            {
                "numQubits": 12581,
                "tCount": 12,
    ...
    def test_building_frontier_from_logical_counts_with_single_params(self, mock_urlopen) -> None:
        logical_counts = LogicalCounts(
            {
                "numQubits": 12581,
                "tCount": 12,
